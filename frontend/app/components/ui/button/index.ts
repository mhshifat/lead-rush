...
export const buttonVariants = cva(
  // A transparent border on the base class ensures every variant lays out at the
  // same box size — outline variants that paint a visible 1px border no longer
  // render at a different height than filled variants.
